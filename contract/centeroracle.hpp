/*
  ...
  Github: https://github.com/proitlab/centraloracle/
...
const std::string SYSTEM_SYMBOL = "VEX";
...
CONTRACT centraloracle : public eosio::contract {
 public:
...
/*
  ...
  void transfer(uint64_t sender, uint64_t receiver) {
    ...
    auto transfer_data = unpack_action_data<centraloracle::st_transfer>();
  ...
  using write_action = action_wrapper<"write"_n, &centraloracle::write>;
  using writehash_action = action_wrapper<"writehash"_n, &centraloracle::writehash>;
  using claim_action = action_wrapper<"claim"_n, &centraloracle::claim>;
  using configure_action = action_wrapper<"configure"_n, &centraloracle::configure>;
  using newbounty_action = action_wrapper<"newbounty"_n, &centraloracle::newbounty>;
  using cancelbounty_action = action_wrapper<"cancelbounty"_n, &centraloracle::cancelbounty>;
  using votebounty_action = action_wrapper<"votebounty"_n, &centraloracle::votebounty>;
  using unvotebounty_action = action_wrapper<"unvotebounty"_n, &centraloracle::unvotebounty>;
  using editbounty_action = action_wrapper<"editbounty"_n, &centraloracle::editbounty>;
  using editpair_action = action_wrapper<"editpair"_n, &centraloracle::editpair>;
  using deletepair_action = action_wrapper<"deletepair"_n, &centraloracle::deletepair>;
  using addcustodian_action = action_wrapper<"addcustodian"_n, &centraloracle::addcustodian>;
  using delcustodian_action = action_wrapper<"delcustodian"_n, &centraloracle::delcustodian>;
  using reguser_action = action_wrapper<"reguser"_n, &centraloracle::reguser>;
  using clear_action = action_wrapper<"clear"_n, &centraloracle::clear>;
  using voteabuser_action = action_wrapper<"voteabuser"_n, &centraloracle::voteabuser>;
  using updateusers_action = action_wrapper<"updateusers"_n, &centraloracle::updateusers>;
  using migratedata_action = action_wrapper<"migratedata"_n, &centraloracle::migratedata>;
  using transfer_action = action_wrapper<name("transfer"), &centraloracle::transfer>;
...
private:
  ...
  bool check_oracle(const name owner){
    ...
    producers_table ptable("vexcore"_n, name("vexcore").value);
